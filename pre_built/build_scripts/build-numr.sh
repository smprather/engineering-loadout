...
echo ""
echo "Commit with:"
echo "  git add pre_built/el8.x86_64.glibc2p28/bin/numr.bz2 \\"
echo "          .strip-manifest pre_built/packages.json \\"
echo "          pre_built/build_scripts/build-numr.sh \\"
echo "          pre_built/build_scripts/farm-versions pre_built/ADDING_BINARIES.md"
echo "  git commit -m 'feat(pre_built): numr ${ver} stable EL8 source build'"
