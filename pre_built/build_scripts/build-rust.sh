...
# pre_built/<platform>/runtime/rust.tar.bz2 for the el8.x86_64.glibc2p28 target.
#
...
# chunks live under pre_built/, "rust.tar.bz2" is added to
# strip_all_elf_binaries' NOSTRIP list so the strip pass never re-tars and
...
echo ""
echo "Done. 'rust.tar.bz2' is in strip_all_elf_binaries' NOSTRIP list, so do NOT"
echo "expect ./strip_all_elf_binaries to touch it. packages.json carries the"
