...
#
# Produces:
#   pre_built/el8.x86_64.glibc2p28/bin/wish.bz2
#   pre_built/el8.x86_64.glibc2p28/lib64/libtcl9tk9.0.so.bz2
#
...
#   ./pre_built/build_scripts/build-tk.sh --tag core-9-0-3
...
with open(path, 'w') as f:
    ...
    f.write('\n')
" "$REPO/pre_built/packages.json" "$VERSION" "$TKLIB_NAME"
