...
#
# Produces:
#   pre_built/el8.x86_64.glibc2p28/bin/tclsh.bz2
...
with open(path, 'w') as f:
    ...
    f.write('\n')
" "$REPO/pre_built/packages.json" "$VERSION" "$TCLLIB_NAME"
...
echo ""
echo "Commit with:"
echo "  git add pre_built/el8.x86_64.glibc2p28/bin/tclsh.bz2 \\"
echo "          pre_built/el8.x86_64.glibc2p28/lib64/${TCLLIB_NAME}.bz2 \\"
echo "          .strip-manifest pre_built/packages.json"
echo "  git commit -m 'feat(pre_built): tcl ${VERSION} EL8 source build'"
