...
#   pre_built/el8.x86_64.glibc2p28/bin/nvim-qt.bz2
...
echo "  git add pre_built/el8.x86_64.glibc2p28/bin/nvim-qt.bz2 .strip-manifest pre_built/packages.json"
echo "  git commit -m 'feat(pre_built): nvim-qt ${tag} EL8 build'"
