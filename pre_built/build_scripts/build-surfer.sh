...
#
#   pre_built/<platform>/bin/surfer.bz2       POSIX-sh wrapper (Mesa/GLVND env)
#   pre_built/<platform>/bin/surfer.bin.bz2   real stripped ELF, RPATH $ORIGIN/../lib64
#
...
#   pre_built/build_scripts/build-surfer.sh --tag v0.7.0 --source /path/to/checkout
#
# After running: ./strip_all_elf_binaries && \
...
BIN_DIR="$REPO/pre_built/$PLATFORM/bin"
...
echo "  git add pre_built/$PLATFORM/bin/surfer.bz2 pre_built/$PLATFORM/bin/surfer.bin.bz2 .strip-manifest"
