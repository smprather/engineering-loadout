...
-- Silence the bell completely. WezTerm defaults audible_bell to "SystemBeep",
-- which on WSL reaches the Windows system beep -- any stray ^G from a shell,
-- pager or TUI turns into an audible bing. "Disabled" mutes it; the zeroed
-- fade times mean the visual bell never flashes the window either.
