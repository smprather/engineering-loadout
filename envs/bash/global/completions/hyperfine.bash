_hyperfine() {
    ...
    case "${cmd}" in
        hyperfine)
            opts="-w -m -M -r -s -p -C -c -P -D -L -S -N -i -u -n -h -V --warmup --min-runs --max-runs --runs --setup --reference --prepare --conclude --cleanup --parameter-scan --parameter-step-size --parameter-list --shell --ignore-failure --style --sort --time-unit --export-asciidoc --export-csv --export-json --export-markdown --export-orgmode --show-output --output --input --command-name --min-benchmarking-time --debug-mode --help --version <command>..."
