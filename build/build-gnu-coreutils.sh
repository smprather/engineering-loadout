...
#   payload/el8.x86_64.glibc2p28/bin/<name>.bz2
#
...
#   build/build-gnu-coreutils.sh --tag 9.6

set -eu

REPO_ROOT="$(cd "$(dirname "$0")/.." && pwd)"
BIN_DIR="$REPO_ROOT/payload/el8.x86_64.glibc2p28/bin"
...
" "$REPO_ROOT/payload/packages.json")"
...
echo "  git add payload/el8.x86_64.glibc2p28/bin/ .strip-manifest"
