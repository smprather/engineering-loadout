...
echo "  git add payload/el8.x86_64.glibc2p28/bin/nedit-ng.bz2 .strip-manifest payload/packages.json"
echo "  git commit -m 'feat(payload): nedit-ng ${tag} stable EL8 source build'"
